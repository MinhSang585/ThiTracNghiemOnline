            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
				    ...
				    while(rs.next()){
						...
						<td><%=rs.getInt("ThoiGianLamBai") %></td>
						<td><%=rs.getDate("NgayGioBatDau") %></td>
						<td><%=rs.getDate("NgayGioKetThuc") %></td>
						<td><a class="btn btn-link" href="Trangtest.jsp?MaDe=<%=rs.getString("MaDe") %>" role="button">Thi </a></td>
						</tr>
						<% 
						}
				%>
