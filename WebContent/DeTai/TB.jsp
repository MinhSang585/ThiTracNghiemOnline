        ...
        <header class="header">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
				    ...
				    //ResultSet rs1;
				    st.execute("exec TBTL @MaHV='"+MaHV+"' ");	
				    rs = st.executeQuery("select * from Bangphu where MaHV='"+MaHV+"'");
				    while(rs.next()){
						%>
						<tr>
						<td><%=rs.getString("MaHV") %></td>
						<td><%=rs.getNString("TenHV") %></td>
						<td><%=rs.getString("NgaySinh") %></td>
						<td><%=rs.getString("GioiTinh") %></td>
						<td><%=rs.getNString("DiaChi") %></td>
						<td><%=rs.getString("SDT") %></td>
						<td><%=rs.getNString("Email") %></td>
