            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
				    ...
				    while(rs.next()){
						%>
						<tr>
						<td><%=rs.getString("MaTest") %></td>
						<td><%=rs.getString("MaDe") %></td>
						<td><%=rs.getString("MaHV") %></td>
						<td><%=rs.getString("NgayTest") %></td>
						<td><%=rs.getString("Diem") %></td>
						<td><%=rs.getString("MaLT") %></td>
						<td><a class="btn btn-link" href="TB.jsp?MaHV=<%=rs.getString("MaHV") %>" role="button">DTB </a></td>
						</tr>
						<% 
						}
				%>
