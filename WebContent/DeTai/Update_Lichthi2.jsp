...
<%  
    ...
    int i = st.executeUpdate("update LichThi set MaLichThi= '"+MaLichThi+"',MaDe= '"+MaDe+"',ThoiGianLamBai= '"+ThoiGianLamBai+"',NgayGioBatDau= '"+NgayGioBatDau+"',NgayGioKetThuc= '"+NgayGioKetThuc+"' where MaLichThi= '"+MaLichThi+"' ");
    if (i > 0)
