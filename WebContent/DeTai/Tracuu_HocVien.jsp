        ...
        <header class="header">
                        ...
                        <section class="sidebar">
                            ...
                            <form action="#" method="get" class="sidebar-form">
                                <div class="input-group">
                                    <input type="text" name="5" class="form-control" placeholder="Search..."/>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
				    ...
				    ResultSet rs;
				    String MaHV = request.getParameter("q");
				    rs = st.executeQuery("exec Timkiem @MaHV='"+MaHV+"' ");
				    while(rs.next()){
						%>
						<tr>
						<td><%=rs.getString("MaHV") %></td>
						<td><%=rs.getString("TenHV") %></td>
						<td><%=rs.getString("NgaySinh") %></td>
						<td><%=rs.getString("GioiTinh") %></td>
						<td><%=rs.getString("DiaChi") %></td>
						<td><%=rs.getInt("SDT") %></td>
						<td><%=rs.getString("Email") %></td>
						<td><a class="btn btn-link" href="Update_HocVien.jsp?MaHV=<%=rs.getString("MaHV") %>" role="button">Update </a>|<a class="btn btn-link" href="Delete_HocVien.jsp?MaHV=<%=rs.getString("MaHV") %>" role="button">Delete </a></td>
						</tr>
						<% 
						}
				%>
