   ...
   <div class="contaner">
      ...
      <div class="row-md-offset-5 row-md-6">
        <div class=" col-md-offset-1 col-md-8"  >
            <table class="table table-bordered" >
              <tr class="backgroup1"><th> <b> <i><p align="center"> Mon:Web</p></i> </b> </th> </tr>  
              <tr><td>
              <form class="form-horizontal">
        <div class="table">
             <table class="table table-bordered col-md-6 " >
               <tr class="backgroup4">
                <th> <b > <i> <h3 align="center"> Ket qua thi cua ban </h3></i> </b> <div class="radio">                
                <p>Tong so cua cua de 01: <font color="red" size="5">15</font> </p>
                <p>So cau dung: <font color="red" size="5">13</font></p>
                <p>So cau sai: <font color="red" size="5">2</font></p>
                <p>Diem: <font color="red" size="5">9</font></p>
                </th> 
               </tr> 
             </table> 
        </div>
                    <div class="form-group">
                      <div class="col-sm-offset-10 col-sm-10">
                         <a class="btn btn-primary" href="file:D:\namhoc_2016_2017\hk1_2016_2017\laptrinhweb\thuc ti\bootstrap-3.3.7-dist/HocVien.html#" role="button">OK</a>
                      </div>
                    </div>
</form>
</td>   </tr> 
