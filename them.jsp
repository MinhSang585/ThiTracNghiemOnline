      ...
      <!-- quan ly tai khoan -->       
       <div class="col-md-2 sidebar backgroup2 col-center">
          <ul class="nav nav-sidebar ">
            ...
            <li><a href="#"></a></li>
            <li><a href="#"></a></li>
            <li class="active backgroup3"><a href="#"><font color="yellow">Them Tai Khoan</font> <span class="sr-only">(current)</span></a></li>           
            <li><a href="#">Update</a></li>
            <li><a href="#">Xoa</a></li>
            <li><a href="file:D:\namhoc_2016_2017\hk1_2016_2017\laptrinhweb\thuc ti\bootstrap-3.3.7-dists/Trangchu.html">Thoat</a></li>
            <li><a href="#"></a></li>
            <li><a href="#"></a></li>
            <li><a href="#"></a></li>
            <li><a href="#"></a></li>
                ...
                <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-8 col-sm-10">
                           <a class="btn btn-danger" href="file:D:\namhoc_2016_2017\hk1_2016_2017\laptrinhweb\thuc ti\bootstrap-3.3.7-dists/Admin.html" role="button">OK</a>
                        </div>
                      </div>
                      </div>
