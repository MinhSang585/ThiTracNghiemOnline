      ...
      <!-- quan ly tai khoan -->       
       <div class="col-md-2 sidebar backgroup2 col-center">
          <ul class="nav nav-sidebar ">
            ...
            <li><a href="#"></a></li>
            <li><a href="#"></a></li>
            <li><a href="#">Lich thi</a></li>
            <li class="active backgroup3"><a href="#"><font color="yellow">Update lich thi</font> <span class="sr-only">(current)</span></a></li>           
        ...
        <div class="col-sm-10  main">
          <!-- <div class="table-responsive"> -->
            <table class="table table-bordered table-center" >   
              ...
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">Ngay bat dau</label>
                <div class="col-sm-offset-1 col-sm-6">
                  <input type="password" class="form-control" id="inputPassword3" placeholder="Ngay bat dau thi">
                </div>
              </div>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">Ngay ket thuc</label>
                <div class="col-sm-offset-1 col-sm-6">
                  <input type="password" class="form-control" id="inputPassword3" placeholder="Ngay ket thuc thi">
                </div>
              </div>
              <!--  -->
                ...
                <div class="col-sm-offset-2 col-sm-10">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-8 col-sm-10">
                           <a class="btn btn-danger" href="file:D:\namhoc_2016_2017\hk1_2016_2017\laptrinhweb\thuc ti\bootstrap-3.3.7-dist/lichthi.html" role="button">OK</a>
                        </div>
                      </div>
                      </div>
