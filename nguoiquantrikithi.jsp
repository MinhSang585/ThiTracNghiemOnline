      ...
      <!-- quan ly tai khoan -->       
       <div class="col-md-2 sidebar backgroup2 col-center">
          <ul class="nav nav-sidebar ">
            ...
            <li><a href="#"></a></li>
            <li><a href="#"></a></li>
            <li class="active backgroup3"><a href="#"><font color="yellow">Lich thi</font> <span class="sr-only">(current)</span></a></li> 
            <li><a href="file:D:\namhoc_2016_2017\hk1_2016_2017\laptrinhweb\thuc ti\bootstrap-3.3.7-dist/capnhatlichthi.html">Update lich thi</a></li>
